  ...
  return (
    <section id="economic-potential" className="py-20 md:py-28 bg-white overflow-visible" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        {/* Title section with gradient like the logo */}
        <div className="mb-20 text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-500">
        ...
        <div className="mb-20 md:mb-28">
          ...
          >
            <div className="grid md:grid-cols-2 gap-8 md:gap-16">
              ...
              >
                <h3 className="text-2xl md:text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">The Vision</h3>
              ...
              >
                <h3 className="text-2xl md:text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">The Movement</h3>
                <p className="text-xl leading-relaxed text-slate-700 mb-6">
