        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-slate-800/20 rounded-lg border border-slate-700 p-6 relative">
            ...
            <p className="text-gray-300">
              Create your profile highlighting your vision, skills, and the complementary talents 
              you're seeking. Share your journey and goals to attract the right partners.
            </p>
          </div>
          ...
          <div className="bg-slate-800/20 rounded-lg border border-slate-700 p-6 relative">
            ...
            <p className="text-gray-300">
              Explore our intelligent matching system to find potential co-founders with complementary 
              skills, shared values, and aligned vision for building impactful ventures.
            </p>
          </div>
          ...
          <div className="bg-slate-800/20 rounded-lg border border-slate-700 p-6 relative">
            ...
            <p className="text-gray-300">
              Connect with potential co-founders through our secure communication platform. Explore 
              synergies, align on values, and test compatibility before committing.
            </p>
          </div>
          ...
          <div className="bg-slate-800/20 rounded-lg border border-slate-700 p-6 relative">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Build & Scale Together</h3>
            <p className="text-gray-300">
              Turn your partnership into a thriving venture with continued access to our community, 
