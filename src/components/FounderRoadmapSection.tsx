      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="ideation" value={openTab} onValueChange={setOpenTab} className="w-full">
          <div className="flex justify-center mb-8">
            <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 bg-slate-800/50">
              {roadmapPhases.map((phase) => (
                <TabsTrigger 
                  key={phase.id} 
                  value={phase.id}
                  className="flex gap-2 items-center data-[state=active]:bg-slate-700"
                >
                  <span className="text-xl mr-1">{phase.icon}</span>
              ...
              <div className="mb-10">
                <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-6 mb-10">
                  <div className="md:w-1/3 text-center md:text-left">
                    <h3 className={`text-3xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r ${phase.color}`}>
                      {phase.title} Phase
                    </h3>
                    <p className="text-slate-300 mb-4">{phase.description}</p>
                    <Button variant="outline" className="border-slate-600 hover:bg-slate-800 hover:text-white">
                    ...
                    {phase.steps.map((step, index) => (
                      <Accordion type="single" collapsible key={index}>
                        <AccordionItem value={`step-${index}`} className="border border-slate-700 rounded-lg mb-4 overflow-hidden">
                          <AccordionTrigger className="px-6 py-4 bg-slate-800/50 hover:bg-slate-800 hover:no-underline">
                            <div className="flex items-center text-left">
                              <span className="bg-slate-700 text-white rounded-full w-8 h-8 flex items-center justify-center mr-4">
                                {index + 1}
                              </span>
                              <div>
                          ...
                          <AccordionContent className="bg-slate-800/30 px-6 py-4">
                ...
                <Card className="bg-gradient-to-r from-slate-800/80 to-slate-900/80 border-slate-700">
                  <CardHeader>
                    <CardTitle className="text-xl font-medium text-white">Need help with this phase?</CardTitle>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="flex items-center space-x-3 bg-slate-800/50 p-4 rounded-md">
                        ...
                        <div>
                          <h4 className="text-white font-medium">Expert Mentoring</h4>
                  ...
                  <CardFooter className="flex justify-between">
                    <Button variant="secondary" className="bg-slate-700 hover:bg-slate-600">Find a Mentor</Button>
        ...
        <div className="mt-16 bg-slate-800/50 rounded-xl p-6 border border-slate-700">
          <Collapsible className="w-full">
            <div className="flex flex-col md:flex-row justify-between items-center mb-6">
              <div>
                <h3 className="text-2xl font-bold text-white mb-2">Ready to accelerate your journey?</h3>
                <p className="text-slate-300">Join our founder accelerator program for personalized guidance and resources.</p>
              </div>
            ...
            <CollapsibleContent className="space-y-4 mt-4 border-t border-slate-700 pt-6">
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-slate-800 p-5 rounded-lg">
                  ...
                  <h4 className="text-lg font-medium text-white mb-2">8-Week Program</h4>
                ...
                <div className="bg-slate-800 p-5 rounded-lg">
                  ...
                  <h4 className="text-lg font-medium text-white mb-2">Startup Cohort</h4>
                ...
                <div className="bg-slate-800 p-5 rounded-lg">
                  ...
                  <h4 className="text-lg font-medium text-white mb-2">Investor Access</h4>
